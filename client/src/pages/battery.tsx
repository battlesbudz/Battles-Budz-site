  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <SEOHead
        ...
        description="Learn about the Battles Budz dual-cart battery accessory, retail purchase requests, and wholesale inquiries."
          ...
          <div className="relative mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
            <div>
              ...
              <p className="inline-flex items-center gap-2 border border-yellow-300/40 bg-yellow-300/10 px-3 py-2 text-xs font-black uppercase tracking-[0.18em] text-yellow-200">
                <BatteryCharging className="h-4 w-4" /> Battles Budz accessory
              </p>
              ...
              <p className="mt-5 max-w-2xl text-lg leading-8 text-zinc-300">
                The Battles Budz dual-cart battery is a branded empty battery accessory built for customers who want a
        ...
        <section className="bg-zinc-950 px-5 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-6 md:grid-cols-3">
            ...
            <article className="rounded-2xl border border-yellow-300/20 bg-black p-7">
              ...
              <p className="mt-3 leading-7 text-zinc-400">
                If a battery arrives defective or stops working, send a photo or video showing the issue and we will
